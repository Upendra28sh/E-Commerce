        ...
        <div className="container_80">
          <Form onSubmit={this.handleSubmit}>
            <FormItem {...formItemLayout} label="Store Policy">
                ...
                <ReactQuill name="ReturnPolicy" style={{lineHeight : '22px'}} modules={modules} formats={formats} value={this.state.ReturnPolicy}
            ...
            <ReactQuill name="StoryPolicy" style={{lineHeight : '22px'}} modules={modules} formats={formats}  value={this.state.StorePolicy}         
               onChange={this.handlestorechange} />
            </FormItem>
            <FormItem {...formItemLayout} label="About">
              
              <ReactQuill name="About" style={{lineHeight : '22px'}} modules={modules} formats={formats} value={this.state.About}           

...
const Landing = (props) => {
    const bgURL = "url('https://images.unsplash.com/photo-1444012104069-996724bf4a0a?dpr=2&fit=crop&fm=jpg&h=825&ixlib=rb-0.3.5&q=50&w=1450')";
    return (
        <div>
            <div
                className="bg-image"
                ...
                <div className='container_20'>
                    <ul className="nav_bar">
                        <svg viewBox="0 0 1000 1000" role="presentation" aria-hidden="true" focusable="false"
                             style={{marginTop: '10px', height: '34px', fill: 'white'}}>
                            <path
                        ...
                        <NavLink to="/signin"><li className="landing_item">Log In</li></NavLink>

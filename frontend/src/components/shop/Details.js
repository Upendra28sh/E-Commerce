                      ...
                      <Col span={12}>
                        ...
                        >
                          <a
                            ...
                            href={`https://facebook.com/sharer/sharer.php?u=http%3A%2F%2Ffrnzy.in%2Ffeed%2F${this.props.location.state.parentFeedId}`}
                            target="_blank"
                          ...
                          <a
                            class="resp-sharing-button__link"
                            href={`https://twitter.com/intent/tweet/?text=http%3A%2F%2Ffrnzy.in%2Ffeed%2F${this.props.location.state.parentFeedId}`}
                            target="_blank"
                          ...
                          <a
                            class="resp-sharing-button__link"
                            href={`whatsapp://send?text= http%3A%2F%2Ffrnzy.in%2Ffeed%2F${this.props.location.state.parentFeedId}`}
                            target="_blank"
                          ...
                          <a
                            class="resp-sharing-button__link"
                            target="_blank"
                            onClick={()=>this.gettochat(this.props.location.state.parentFeedId)}

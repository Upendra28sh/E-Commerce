  ...
  render() {
    return (
      <div className="make-3D-space" style={{ margin: "auto" }}>
        <div
          className={`product-card ${this.state.addClass}`}
        ...
        >
          <div className="product-card__front">
            ...
            <div
              ...
              style={{
                backgroundImage: `url("/product_images/${
            ...
            <Link to={`/admin/listing/${this.props.product.id}`}>
            ...
            <div className="product-card__stats">
              <div className="stats-container">
                ...
                <div className="product-card__options">
                  <strong>SIZES</strong>
                  <span>{this.props.product.sizes.toString()}</span>
